...
- [ ] Make sure to open an issue as a [bug/issue](https://github.com/googleapis/nodejs-googleapis-common/issues/new/choose) before writing your code! That way we can discuss the change, evaluate designs, and agree on the general idea
